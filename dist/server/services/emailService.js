...
class EmailService {
     ...
     */
    async sendBackupEmail(zipBuffer, filename, clientCount) {
     ...
     */
    async sendUserEmail(userEmail, emailType, data = {}) {
        let subject = '';
        let body = '';
        switch (emailType) {
            case 'welcome':
    ...
    generateDeviceBlockedEmail(data) {
    ...
    generateDailySummaryEmail(data) {
    ...
    generateUserPaymentConfirmedEmail(data) {
        return `
      <h2>✅ Payment Confirmed!</h2>
    ...
    generatePaymentReminderEmail(data) {
        return `
    ...
    generateLicenseDeactivatedEmail(data) {
        return `
